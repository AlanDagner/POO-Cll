        ...
        do {
            ...
            switch (opt) {
                ...
                case 4:
                    ...
                    ap.setId(Integer.parseInt(input.nextLine()));
                     
                    System.out.print("Ingrese el Nombre: ");
                    ap.setNombre(input.nextLine());
                     
                    System.out.print("Ingrese el : ");
                    ap.setAp_paterno(input.nextLine());
                     
                    System.out.print("Ungrese ID: ");
                    ap.setAp_materno(input.nextLine());
                     
                    System.out.print("Ungrese ID: ");
                    ap.setSexo(input.nextLine());
